...
<section class="group" id="sideContent">
    <div class="relative min-h-screen left-0 w-full transition-all duration-500 ease-in-out z-0 top-0 p-4 sm:group-[.open]:w-[calc(100%_-_250px)] sm:group-[.open]:left-[250px] sm:left-[78px] sm:w-[calc(100%_-_78px)]">
        ...
        <div class="container mx-auto px-4 py-8 rounded-lg mt-4 border border-gray-400" style="background-color: #ffffff; max-width: 1000px; padding: 20px;">
            ...
            <form class="flex flex-col space-y-4" method="POST" action="{{ route('badge.store') }}" enctype="multipart/form-data">
                @csrf
                @method('POST')
                ...
                <div class="flex flex-col " style="margin-bottom:30px;">
                    <label class="form-control w-full">
                        ...
                        <textarea class="textarea textarea-bordered h-24 w-full  " placeholder="Enter Description Here" id="description" name="description"></textarea>
                    </label>
                </div>
                @error('description')
                    <div class="mb-1">
                ...
                <div class="flex flex-col" style="margin-bottom:30px;">
                    ...
                    <input type="file" id="badgeImage" name="image" class="rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-500" onchange="previewImage(this)">
                    <img id="preview" src="#" alt="Preview badgeImage" style="display: none; max-width: 70%; margin-top: 10px;">
                </div>
                </label>
                @error('image')
                    <div class="mb-1">
