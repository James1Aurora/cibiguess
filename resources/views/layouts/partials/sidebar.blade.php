<div
    ...
    <div class="h-[60px] flex justify-between items-center relative">
        <div>
            <p class="text-2xl font-bold opacity-0 transition-all duration-75 ease-in-out group-[.open]:opacity-100">
                CibiGuess
            </p>
        </div>
    ...
    <ul class="h-full mt-5">
        <li class="group/nav-link relative mx-0 my-2">
            <a href="#"
                ...
                <i
                    class="material-symbols-outlined h-[50px] min-w-[47px] !text-xl text-center !leading-[50px]">window</i>
                <span
        ...
        <li class="group/nav-link relative mx-0 my-2">
            <a href="daftarUser.html"
                ...
                <i
                    class="material-symbols-outlined filled h-[50px] min-w-[47px] !text-xl text-center !leading-[50px]">account_box</i>
                <span
